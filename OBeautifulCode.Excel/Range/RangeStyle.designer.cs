...
namespace OBeautifulCode.Excel
{
    ...
    public partial class RangeStyle : IModel<RangeStyle>
    {
        ...
        {
            var result = Invariant($"OBeautifulCode.Excel.RangeStyle: BackgroundColor = {this.BackgroundColor?.ToString() ?? "<null>"}, FontColor = {this.FontColor?.ToString() ?? "<null>"}, FontName = {this.FontName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, FontSize = {this.FontSize?.ToString() ?? "<null>"}, FontIsItalic = {this.FontIsItalic?.ToString() ?? "<null>"}, FontIsBold = {this.FontIsBold?.ToString() ?? "<null>"}, FontUnderline = {this.FontUnderline?.ToString() ?? "<null>"}, FontRotationAngle = {this.FontRotationAngle?.ToString() ?? "<null>"}, TextIsWrapped = {this.TextIsWrapped?.ToString() ?? "<null>"}, IndentLevel = {this.IndentLevel?.ToString() ?? "<null>"}, RowHeightInPixels = {this.RowHeightInPixels?.ToString() ?? "<null>"}, ColumnWidthInPixels = {this.ColumnWidthInPixels?.ToString() ?? "<null>"}, VerticalAlignment = {this.VerticalAlignment?.ToString() ?? "<null>"}, HorizontalAlignment = {this.HorizontalAlignment?.ToString() ?? "<null>"}, MergeCells = {this.MergeCells?.ToString() ?? "<null>"}, AutofitRows = {this.AutofitRows?.ToString() ?? "<null>"}, InsideBorder = {this.InsideBorder?.ToString() ?? "<null>"}, OutsideBorder = {this.OutsideBorder?.ToString() ?? "<null>"}, DataValidation = {this.DataValidation?.ToString() ?? "<null>"}, Format = {this.Format?.ToString() ?? "<null>"}, CustomFormatString = {this.CustomFormatString?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
