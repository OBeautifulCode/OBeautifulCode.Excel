    ...
    public partial class RangeStyle : IModel<RangeStyle>
    {
        ...
        public RangeStyle DeepClone()
        {
            var result = new RangeStyle
                             {
                                 BackgroundColor     = this.BackgroundColor?.DeepClone(),
                                 FontColor           = this.FontColor?.DeepClone(),
                                 FontName            = this.FontName?.DeepClone(),
                                 FontSize            = this.FontSize?.DeepClone(),
                                 FontIsItalic        = this.FontIsItalic?.DeepClone(),
                                 FontIsBold          = this.FontIsBold?.DeepClone(),
                                 FontUnderline       = this.FontUnderline?.DeepClone(),
                                 FontRotationAngle   = this.FontRotationAngle?.DeepClone(),
                                 TextIsWrapped       = this.TextIsWrapped?.DeepClone(),
                                 IndentLevel         = this.IndentLevel?.DeepClone(),
                                 RowHeightInPixels   = this.RowHeightInPixels?.DeepClone(),
                                 ColumnWidthInPixels = this.ColumnWidthInPixels?.DeepClone(),
                                 VerticalAlignment   = this.VerticalAlignment?.DeepClone(),
                                 HorizontalAlignment = this.HorizontalAlignment?.DeepClone(),
                                 MergeCells          = this.MergeCells?.DeepClone(),
                                 AutofitRows         = this.AutofitRows?.DeepClone(),
                                 ...
                                 Format              = this.Format?.DeepClone(),
                                 CustomFormatString  = this.CustomFormatString?.DeepClone(),
                             };
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.FontIsItalic, options, propertyPathTracker, nameof(this.FontIsItalic));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.FontUnderline, options, propertyPathTracker, nameof(this.FontUnderline));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.TextIsWrapped, options, propertyPathTracker, nameof(this.TextIsWrapped));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.IndentLevel, options, propertyPathTracker, nameof(this.IndentLevel));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.RowHeightInPixels, options, propertyPathTracker, nameof(this.RowHeightInPixels));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ColumnWidthInPixels, options, propertyPathTracker, nameof(this.ColumnWidthInPixels));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.MergeCells, options, propertyPathTracker, nameof(this.MergeCells));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.AutofitRows, options, propertyPathTracker, nameof(this.AutofitRows));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.InsideBorder, options, propertyPathTracker, nameof(this.InsideBorder));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.OutsideBorder, options, propertyPathTracker, nameof(this.OutsideBorder));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.DataValidation, options, propertyPathTracker, nameof(this.DataValidation));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.CustomFormatString, options, propertyPathTracker, nameof(this.CustomFormatString));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
