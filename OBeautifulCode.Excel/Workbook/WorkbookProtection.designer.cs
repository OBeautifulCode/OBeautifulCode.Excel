...
namespace OBeautifulCode.Excel
{
    ...
    [Serializable]
    public partial class WorkbookProtection : IModel<WorkbookProtection>
    {
        /// <summary>
        /// Determines whether two objects of type <see cref="WorkbookProtection"/> are equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are equal; otherwise false.</returns>
        public static bool operator ==(WorkbookProtection left, WorkbookProtection right)
        {
        ...
        /// <summary>
        /// Determines whether two objects of type <see cref="WorkbookProtection"/> are not equal.
        /// </summary>
        /// <param name="left">The object to the left of the equality operator.</param>
        /// <param name="right">The object to the right of the equality operator.</param>
        /// <returns>true if the two items are not equal; otherwise false.</returns>
        public static bool operator !=(WorkbookProtection left, WorkbookProtection right) => !(left == right);

        /// <inheritdoc />
        public bool Equals(WorkbookProtection other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => this == (obj as WorkbookProtection);
        ...
        /// <inheritdoc />
        public WorkbookProtection DeepClone()
        {
            var result = new WorkbookProtection
                             {
                                 ClearTextPassword = this.ClearTextPassword?.DeepClone(),
                             };
        ...
        /// <returns>New <see cref="WorkbookProtection" /> using the specified <paramref name="clearTextPassword" /> for <see cref="ClearTextPassword" /> and a deep clone of every other property.</returns>
        ...
        public WorkbookProtection DeepCloneWithClearTextPassword(string clearTextPassword)
        {
            var result = new WorkbookProtection
                             {
        ...
        {
            var result = Invariant($"OBeautifulCode.Excel.WorkbookProtection: ClearTextPassword = {this.ClearTextPassword?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}.");
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.ClearTextPassword, options, propertyPathTracker, nameof(this.ClearTextPassword));
