...
namespace OBeautifulCode.Excel
{
    ...
    [Serializable]
    public partial class Border : IModel<Border>
    {
        /// <summary>
        ...
        public static bool operator !=(Border left, Border right) => !(left == right);
        ...
        public bool Equals(Border other)
        {
            ...
            var result = this.Edges.IsEqualTo(other.Edges)
        ...
        public Border DeepClone()
        {
            var result = new Border
                             {
                                 Edges = this.Edges.DeepClone(),
                                 Style = this.Style.DeepClone(),
                                 Color = this.Color.DeepClone(),
                             };
        ...
        /// <returns>New <see cref="Border" /> using the specified <paramref name="edges" /> for <see cref="Edges" /> and a deep clone of every other property.</returns>
        ...
        public Border DeepCloneWithEdges(BorderEdges edges)
        {
            var result = new Border
                             {
                                 Edges = edges,
        ...
        /// <returns>New <see cref="Border" /> using the specified <paramref name="style" /> for <see cref="Style" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public Border DeepCloneWithStyle(BorderStyle style)
        {
            var result = new Border
                             {
                                 Edges = this.Edges.DeepClone(),
        ...
        /// <returns>New <see cref="Border" /> using the specified <paramref name="color" /> for <see cref="Color" /> and a deep clone of every other property.</returns>
        [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists")]
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity")]
        [SuppressMessage("Microsoft.Design", "CA1054:UriParametersShouldNotBeStrings")]
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly")]
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic")]
        public Border DeepCloneWithColor(Color color)
        {
            var result = new Border
                             {
                                 Edges = this.Edges.DeepClone(),
        ...
        {
            var result = Invariant($"OBeautifulCode.Excel.Border: Edges = {this.Edges.ToString() ?? "<null>"}, Style = {this.Style.ToString() ?? "<null>"}, Color = {this.Color.ToString() ?? "<null>"}.");
