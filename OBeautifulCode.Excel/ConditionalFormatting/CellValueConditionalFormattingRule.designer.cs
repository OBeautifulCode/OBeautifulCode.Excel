    ...
    public partial class CellValueConditionalFormattingRule : IModel<CellValueConditionalFormattingRule>
    {
            ...
            PropertyPathTracker propertyPathTracker = null)
        {
            ...
            void ValidateProperties()
            {
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.StopIfTrue, options, propertyPathTracker, nameof(this.StopIfTrue));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
                ...
                localValidationFailures = ValidatableExtensions.GetValidationFailures(this.RangeStyle, options, propertyPathTracker, nameof(this.RangeStyle));
                result.AddRange(localValidationFailures);
                if (stopOnFirstObjectWithFailures && result.Any())
                {
                    return;
