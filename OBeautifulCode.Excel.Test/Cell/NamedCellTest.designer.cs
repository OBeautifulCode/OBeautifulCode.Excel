...
namespace OBeautifulCode.Excel.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<NamedCell> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<NamedCell>()
            .AddScenario(() =>
                new StringRepresentationTestScenario<NamedCell>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<NamedCell>
                        {
                            SystemUnderTest = systemUnderTest,
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.Excel.NamedCell: Name = {systemUnderTest.Name?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, Cell = {systemUnderTest.Cell?.ToString() ?? "<null>"}."),
                        };
        ...
        private static readonly ConstructorArgumentValidationTestScenarios<NamedCell> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<NamedCell>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<NamedCell>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'name' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<NamedCell>();
        ...
        private static readonly ConstructorPropertyAssignmentTestScenarios<NamedCell> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<NamedCell>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<NamedCell>
                {
                    ...
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<NamedCell>
                        {
                            SystemUnderTest = new NamedCell(
                                                      referenceObject.Name,
                                                      referenceObject.Cell),
        ...
        private static readonly DeepCloneWithTestScenarios<NamedCell> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<NamedCell>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<NamedCell>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<NamedCell>().ThatIs(_ => !systemUnderTest.Name.IsEqualTo(_.Name));

                        var result = new SystemUnderTestDeepCloneWithValue<NamedCell>
                        {
                            SystemUnderTest = systemUnderTest,
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<NamedCell>
                {
                    ...
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        ...
                        var referenceObject = A.Dummy<NamedCell>().ThatIs(_ => !systemUnderTest.Cell.IsEqualTo(_.Cell));
        ...
        private static readonly NamedCell ReferenceObjectForEquatableTestScenarios = A.Dummy<NamedCell>();

        private static readonly EquatableTestScenarios<NamedCell> EquatableTestScenarios = new EquatableTestScenarios<NamedCell>()
            .AddScenario(() =>
                new EquatableTestScenario<NamedCell>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new NamedCell[]
                    {
                        new NamedCell(
                                ReferenceObjectForEquatableTestScenarios.Name,
                                ReferenceObjectForEquatableTestScenarios.Cell),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new NamedCell[]
                    {
                        new NamedCell(
                                A.Dummy<NamedCell>().Whose(_ => !_.Name.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Name)).Name,
                                ReferenceObjectForEquatableTestScenarios.Cell),
                        new NamedCell(
                                ReferenceObjectForEquatableTestScenarios.Name,
                                A.Dummy<NamedCell>().Whose(_ => !_.Cell.IsEqualTo(ReferenceObjectForEquatableTestScenarios.Cell)).Cell),
                    },
        ...
        private static readonly ValidModelTestScenarios<NamedCell> ValidModelTestScenarios = new ValidModelTestScenarios<NamedCell>()
            .AddScenario(() =>
                new ValidModelTestScenario<NamedCell>
                {
                    Name = "a dummy NamedCell should be valid",
                    SystemUnderTest = A.Dummy<NamedCell>(),
                });
        ...
        public static class Structural
        {
            ...
            public static void NamedCell___Should_implement_IModel_of_NamedCell___When_reflecting()
            {
                // Arrange
                var type = typeof(NamedCell);

                var expectedModelMethods = typeof(IModel<NamedCell>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<NamedCell>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void NamedCell___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(NamedCell);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (NamedCell)systemUnderTest.Clone();
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                if (systemUnderTest.Cell == null)
                {
                    actual.Cell.AsTest().Must().BeNull();
                }
                else if (!actual.Cell.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                    actual.Cell.AsTest().Must().NotBeSameReferenceAs(systemUnderTest.Cell);
                }
            }
            ...
            {
                var propertyNames = new string[] { "Name", "Cell" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (NamedCell)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(NamedCell).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Equality
        {
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_NamedCell___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
