...
namespace OBeautifulCode.Excel.Test
{
    ...
    {
        private static readonly StringRepresentationTestScenarios<CellReference> StringRepresentationTestScenarios = new StringRepresentationTestScenarios<CellReference>();

        private static readonly ConstructorArgumentValidationTestScenarios<CellReference> ConstructorArgumentValidationTestScenarios = new ConstructorArgumentValidationTestScenarios<CellReference>()
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CellReference>
                {
                    Name = "constructor should throw ArgumentNullException when parameter 'worksheetName' is null scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CellReference>();

                        var result = new CellReference(
                                             null,
                                             referenceObject.RowNumber,
                                             referenceObject.ColumnNumber);

                        return result;
                    },
                    ExpectedExceptionType = typeof(ArgumentNullException),
                    ExpectedExceptionMessageContains = new[] { "worksheetName", },
                })
            .AddScenario(() =>
                new ConstructorArgumentValidationTestScenario<CellReference>
                {
                    Name = "constructor should throw ArgumentException when parameter 'worksheetName' is white space scenario",
                    ConstructionFunc = () =>
                    {
                        var referenceObject = A.Dummy<CellReference>();
                    ...
                    ExpectedExceptionMessageContains = new[] { "worksheetName", "white space", },
                });

        private static readonly ConstructorPropertyAssignmentTestScenarios<CellReference> ConstructorPropertyAssignmentTestScenarios = new ConstructorPropertyAssignmentTestScenarios<CellReference>()
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CellReference>
                {
                    Name = "WorksheetName should return same 'worksheetName' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CellReference>();

                        var result = new SystemUnderTestExpectedPropertyValue<CellReference>
                        {
                            SystemUnderTest = new CellReference(
                                                      referenceObject.WorksheetName,
                                                      referenceObject.RowNumber,
                                                      referenceObject.ColumnNumber),
                            ExpectedPropertyValue = referenceObject.WorksheetName,
                        };

                        return result;
                    },
                    PropertyName = "WorksheetName",
                })
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CellReference>
                {
                    Name = "RowNumber should return same 'rowNumber' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CellReference>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CellReference>
                        {
                            SystemUnderTest = new CellReference(
                                                      ...
                                                      referenceObject.RowNumber,
                                                      referenceObject.ColumnNumber),
                            ExpectedPropertyValue = referenceObject.RowNumber,
                        };
            ...
            .AddScenario(() =>
                new ConstructorPropertyAssignmentTestScenario<CellReference>
                {
                    Name = "ColumnNumber should return same 'columnNumber' parameter passed to constructor when getting",
                    SystemUnderTestExpectedPropertyValueFunc = () =>
                    {
                        var referenceObject = A.Dummy<CellReference>();
                        ...
                        var result = new SystemUnderTestExpectedPropertyValue<CellReference>
                        {
                            SystemUnderTest = new CellReference(
                                                      ...
                                                      referenceObject.RowNumber,
                                                      referenceObject.ColumnNumber),
                            ExpectedPropertyValue = referenceObject.ColumnNumber,
                        };
        ...
        private static readonly DeepCloneWithTestScenarios<CellReference> DeepCloneWithTestScenarios = new DeepCloneWithTestScenarios<CellReference>()
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellReference>
                {
                    Name = "DeepCloneWithWorksheetName should deep clone object and replace WorksheetName with the provided worksheetName",
                    WithPropertyName = "WorksheetName",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CellReference>();

                        var referenceObject = A.Dummy<CellReference>().ThatIs(_ => !systemUnderTest.WorksheetName.IsEqualTo(_.WorksheetName));

                        var result = new SystemUnderTestDeepCloneWithValue<CellReference>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.WorksheetName,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellReference>
                {
                    Name = "DeepCloneWithRowNumber should deep clone object and replace RowNumber with the provided rowNumber",
                    WithPropertyName = "RowNumber",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CellReference>();

                        var referenceObject = A.Dummy<CellReference>().ThatIs(_ => !systemUnderTest.RowNumber.IsEqualTo(_.RowNumber));

                        var result = new SystemUnderTestDeepCloneWithValue<CellReference>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.RowNumber,
                        };
            ...
            .AddScenario(() =>
                new DeepCloneWithTestScenario<CellReference>
                {
                    Name = "DeepCloneWithColumnNumber should deep clone object and replace ColumnNumber with the provided columnNumber",
                    WithPropertyName = "ColumnNumber",
                    SystemUnderTestDeepCloneWithValueFunc = () =>
                    {
                        var systemUnderTest = A.Dummy<CellReference>();

                        var referenceObject = A.Dummy<CellReference>().ThatIs(_ => !systemUnderTest.ColumnNumber.IsEqualTo(_.ColumnNumber));

                        var result = new SystemUnderTestDeepCloneWithValue<CellReference>
                        {
                            SystemUnderTest = systemUnderTest,
                            DeepCloneWithValue = referenceObject.ColumnNumber,
                        };
        ...
        private static readonly CellReference ReferenceObjectForEquatableTestScenarios = A.Dummy<CellReference>();

        private static readonly EquatableTestScenarios<CellReference> EquatableTestScenarios = new EquatableTestScenarios<CellReference>()
            .AddScenario(() =>
                new EquatableTestScenario<CellReference>
                {
                    Name = "Default Code Generated Scenario",
                    ReferenceObject = ReferenceObjectForEquatableTestScenarios,
                    ObjectsThatAreEqualToButNotTheSameAsReferenceObject = new CellReference[]
                    {
                        new CellReference(
                                ReferenceObjectForEquatableTestScenarios.WorksheetName,
                                ReferenceObjectForEquatableTestScenarios.RowNumber,
                                ReferenceObjectForEquatableTestScenarios.ColumnNumber),
                    },
                    ObjectsThatAreNotEqualToReferenceObject = new CellReference[]
                    {
                        new CellReference(
                                A.Dummy<CellReference>().Whose(_ => !_.WorksheetName.IsEqualTo(ReferenceObjectForEquatableTestScenarios.WorksheetName)).WorksheetName,
                                ReferenceObjectForEquatableTestScenarios.RowNumber,
                                ReferenceObjectForEquatableTestScenarios.ColumnNumber),
                        new CellReference(
                                ReferenceObjectForEquatableTestScenarios.WorksheetName,
                                A.Dummy<CellReference>().Whose(_ => !_.RowNumber.IsEqualTo(ReferenceObjectForEquatableTestScenarios.RowNumber)).RowNumber,
                                ReferenceObjectForEquatableTestScenarios.ColumnNumber),
                        new CellReference(
                                ReferenceObjectForEquatableTestScenarios.WorksheetName,
                                ReferenceObjectForEquatableTestScenarios.RowNumber,
                                A.Dummy<CellReference>().Whose(_ => !_.ColumnNumber.IsEqualTo(ReferenceObjectForEquatableTestScenarios.ColumnNumber)).ColumnNumber),
                    },
        ...
        private static readonly ValidModelTestScenarios<CellReference> ValidModelTestScenarios = new ValidModelTestScenarios<CellReference>()
            .AddScenario(() =>
                new ValidModelTestScenario<CellReference>
                {
                    Name = "a dummy CellReference should be valid",
                    SystemUnderTest = A.Dummy<CellReference>(),
                });
        ...
        public static class Structural
        {
            ...
            public static void CellReference___Should_implement_IModel_of_CellReference___When_reflecting()
            {
                // Arrange
                var type = typeof(CellReference);

                var expectedModelMethods = typeof(IModel<CellReference>).GetInterfaceDeclaredAndImplementedMethods();
                ...
                // Assert
                actualInterfaces.AsTest().Must().ContainElement(typeof(IModel<CellReference>));
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CellReference___Should_declare_ToString_method___When_reflecting()
            {
                // Arrange
                var expected = typeof(CellReference);
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void CellReference___Should_be_attributed_with_Serializable____When_reflecting()
            {
                // Arrange
                var type = typeof(CellReference);
        ...
        public static class Cloning
        {
            ...
            public static void Clone___Should_clone_object___When_called()
            {
                ...
                // Act
                var actual = (CellReference)systemUnderTest.Clone();
            ...
            {
                var propertyNames = new string[] { "WorksheetName", "RowNumber", "ColumnNumber" };
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    // Act
                    var actual = (CellReference)scenario.DeepCloneWithMethod.Invoke(scenario.SystemUnderTest, new[] { scenario.WithValue });

                    // Assert
                    foreach (var propertyName in propertyNames)
                    {
                        var propertyInfo = typeof(CellReference).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
        ...
        public static class Equality
        {
            ...
            [SuppressMessage("Microsoft.Naming", "CA1726:UsePreferredTerms")]
            [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly")]
            public static void Equals_with_CellReference___Should_return_false___When_parameter_other_is_derived_from_the_same_type_but_is_not_of_the_same_type_as_this_object()
            {
                var scenarios = EquatableTestScenarios.ValidateAndPrepareForTesting();
