...
namespace OBeautifulCode.Excel.Test
{
    ...
    public static partial class NumericDataValidationTest
    {
        ...
        private static readonly ValidModelTestScenarios<NumericDataValidation> ValidModelTestScenarios = new ValidModelTestScenarios<NumericDataValidation>()
            .AddScenario(() =>
                new ValidModelTestScenario<NumericDataValidation>
                {
                    Name = "a dummy NumericDataValidation should be valid",
                    SystemUnderTest = A.Dummy<NumericDataValidation>(),
                });
