...
namespace OBeautifulCode.Excel.Test
{
    ...
    public static partial class TextDataValidationTest
    {
        ...
        private static readonly ValidModelTestScenarios<TextDataValidation> ValidModelTestScenarios = new ValidModelTestScenarios<TextDataValidation>()
            .AddScenario(() =>
                new ValidModelTestScenario<TextDataValidation>
                {
                    Name = "a dummy TextDataValidation should be valid",
                    SystemUnderTest = A.Dummy<TextDataValidation>(),
                });
        ...
        public static class Structural
        {
            ...
            public static void TextDataValidation___Should_implement_IModel_of_TextDataValidation___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<TextDataValidation>).GetInterfaceDeclaredAndImplementedMethods();
        ...
        public static class Cloning
        {
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(TextDataValidation).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
