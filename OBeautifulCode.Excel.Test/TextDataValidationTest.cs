...
namespace OBeautifulCode.Excel.Test
{
    ...
    public static class TextDataValidationTest
    {
        ...
        public static void Deserialize___Should_roundtrip_object___When_serializing_and_deserializing_using_NaosBsonSerializer()
        {
            ...
            // Act
            var actual = serializer.Deserialize<TextDataValidation>(serializedBson);
...
#pragma warning restore CS1718 // Comparison made to same variable
        ...
        {
            // Arrange
            var systemUnderTest1 = new TextDataValidation();
            var systemUnderTest2 = A.Dummy<TextDataValidation>();
