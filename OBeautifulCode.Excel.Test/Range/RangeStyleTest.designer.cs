                ...
                new StringRepresentationTestScenario<RangeStyle>
                {
                    ...
                    SystemUnderTestExpectedStringRepresentationFunc = () =>
                    {
                        ...
                        var result = new SystemUnderTestExpectedStringRepresentation<RangeStyle>
                        {
                            ...
                            ExpectedStringRepresentation = Invariant($"OBeautifulCode.Excel.RangeStyle: BackgroundColor = {systemUnderTest.BackgroundColor?.ToString() ?? "<null>"}, FontColor = {systemUnderTest.FontColor?.ToString() ?? "<null>"}, FontName = {systemUnderTest.FontName?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}, FontSize = {systemUnderTest.FontSize?.ToString() ?? "<null>"}, FontIsItalic = {systemUnderTest.FontIsItalic?.ToString() ?? "<null>"}, FontIsBold = {systemUnderTest.FontIsBold?.ToString() ?? "<null>"}, FontUnderline = {systemUnderTest.FontUnderline?.ToString() ?? "<null>"}, FontRotationAngle = {systemUnderTest.FontRotationAngle?.ToString() ?? "<null>"}, TextIsWrapped = {systemUnderTest.TextIsWrapped?.ToString() ?? "<null>"}, IndentLevel = {systemUnderTest.IndentLevel?.ToString() ?? "<null>"}, RowHeightInPixels = {systemUnderTest.RowHeightInPixels?.ToString() ?? "<null>"}, ColumnWidthInPixels = {systemUnderTest.ColumnWidthInPixels?.ToString() ?? "<null>"}, VerticalAlignment = {systemUnderTest.VerticalAlignment?.ToString() ?? "<null>"}, HorizontalAlignment = {systemUnderTest.HorizontalAlignment?.ToString() ?? "<null>"}, MergeCells = {systemUnderTest.MergeCells?.ToString() ?? "<null>"}, AutofitRows = {systemUnderTest.AutofitRows?.ToString() ?? "<null>"}, InsideBorder = {systemUnderTest.InsideBorder?.ToString() ?? "<null>"}, OutsideBorder = {systemUnderTest.OutsideBorder?.ToString() ?? "<null>"}, DataValidation = {systemUnderTest.DataValidation?.ToString() ?? "<null>"}, Format = {systemUnderTest.Format?.ToString() ?? "<null>"}, CustomFormatString = {systemUnderTest.CustomFormatString?.ToString(CultureInfo.InvariantCulture) ?? "<null>"}."),
                        };
