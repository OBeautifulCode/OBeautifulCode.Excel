...
namespace OBeautifulCode.Excel.Test
{
    ...
    public static partial class RangeStyleTest
    {
        ...
        private static readonly ValidModelTestScenarios<RangeStyle> ValidModelTestScenarios = new ValidModelTestScenarios<RangeStyle>()
            .AddScenario(() =>
                new ValidModelTestScenario<RangeStyle>
                {
                    Name = "a dummy RangeStyle should be valid",
                    SystemUnderTest = A.Dummy<RangeStyle>(),
                });
        ...
        public static class Structural
        {
            ...
            public static void RangeStyle___Should_implement_IModel_of_RangeStyle___When_reflecting()
            {
                ...
                var expectedModelMethods = typeof(IModel<RangeStyle>).GetInterfaceDeclaredAndImplementedMethods();
        ...
        public static class Cloning
        {
            ...
            public static void DeepClone___Should_deep_clone_object___When_called()
            {
                ...
                else if (!actual.InsideBorder.GetType().IsValueType)
                {
                ...
                else if (!actual.OutsideBorder.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
                ...
                else if (!actual.DataValidation.GetType().IsValueType)
                {
                    // When the declared type is a reference type, we still have to check the runtime type.
                    // The object could be a boxed value type, which will fail this asseration because
                    // a deep clone of a value type object is the same object.
            ...
            public static void DeepCloneWith___Should_deep_clone_object_and_replace_the_associated_property_with_the_provided_value___When_called()
            {
                ...
                foreach (var scenario in scenarios)
                {
                    ...
                    {
                        var propertyInfo = typeof(RangeStyle).GetPropertyFiltered(propertyName, MemberRelationships.DeclaredOrInherited, MemberOwners.Instance, MemberAccessModifiers.Public);
